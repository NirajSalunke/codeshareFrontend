        ...
        <div className="size-full max-w-2xl h-full flex flex-col items-center justify-center text-center overflow-hidden">
          ...
          <BoxReveal boxColor={"#5046e6"} duration={0.5}>
            <div className="mt-6 space-y-2 flex gap-5">
              <p>
                <a target="_blank" href="https://github.com/NirajSalunke">
                  <img
                    alt="github"
                    src="https://skillicons.dev/icons?i=github&perline=1"
                  />
                </a>
              </p>
              <p>
              ...
              <p>
                {/* <span className="text-[#5046e6] font-semibold">Portfolio:</span>{" "} */}
